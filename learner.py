...
from models import TCompoundQ
from regularizers import Lambda3, wN3


parser = argparse.ArgumentParser(
    description="TCompoundQ"
)
parser.add_argument(
...
parser.add_argument(
    '--model', default='TCompoundQ', type=str,
    help="Model Name"
)
parser.add_argument(
...
parser.add_argument(
    '--rank', default=6000, type=int,
    help="Factorization rank."
)
parser.add_argument(
    '--batch_size', default=3000, type=int,
    help="Batch size."
)
parser.add_argument(
    '--learning_rate', default=5e-2, type=float,
    help="Learning rate"
)
parser.add_argument(
...
def learn(model=args.model,
    ...
    model = {
        'TCompoundQ': TCompoundQ(sizes, rank, no_time_emb=args.no_time_emb),
    }[model]
    model = model.cuda(num_of_cuda)
